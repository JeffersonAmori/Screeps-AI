// from https://stackoverflow.com/questions/68295113/how-to-implement-the-publish-subscribe-pattern-in-typescript

import { SpawnNewCreepCommand } from "../Core/Commands/SpawnNewCreepCommand"
...
export function messageBroker<E>(): PubSubType<E> {
...
export let messageBrokerInstance: PubSubType<commands> = messageBroker<commands>()

export type commands = {
  SpawnNewCreepCommand: SpawnNewCreepCommand
}
